...
This file shows a breakdown of the input text according to the selected list. For each condition (on or off list), you can find information on how many words meet the condition (word count), how many word families meet the condition (family count), and the coverage provided as a percentage of the whole.

2. word_family_statistics.csv
This file shows a breakdown of the input text according to the word family headwords that appear in the text. For each headword, you can find information on how many times it appears (number of occurrences), whether it is on- or off-list, and the family members appearing in the text with their raw counts appearing in parenthesis. 
